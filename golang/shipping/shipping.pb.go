...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\r.ShippingItemR\x05items\"X\n" +
	"\x16CreateShippingResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\x12#\n" +
	"\rdelivery_days\x18\x02 \x01(\x05R\fdeliveryDays2G\n" +
	"\bShipping\x12;\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponse\"\x00B;Z9github.com/sheilallee/microservices-proto/golang/shippingb\x06proto3"
